...
export default function HostingCloudServicePage() {
    ...
    const features = [
        { icon: <FaServer className="text-3xl" />, title: t('features.shared.title'), description: t('features.shared.description') },
        { icon: <FaCloud className="text-3xl" />, title: t('features.cloud.title'), description: t('features.cloud.description') },
        { icon: <FaShieldAlt className="text-3xl" />, title: t('features.secure.title'), description: t('features.secure.description') },
        { icon: <FaDatabase className="text-3xl" />, title: t('features.database.title'), description: t('features.database.description') },
        { icon: <FaSyncAlt className="text-3xl" />, title: t('features.backup.title'), description: t('features.backup.description') },
                    ...
                    >
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                            {t.rich('featuresSection.title', {
                                highlight1: (chunks) => <span className="text-[#2EB6EE]">{chunks}</span>,
                                highlight2: (chunks) => <span className="text-[#8FBE53]">{chunks}</span>
                            })}
                        </h2>
            ...
            <section className="py-20 px-6 bg-gray-50">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mt-16 grid md:grid-cols-3 gap-8">
                        ...
                        >
                            <h3 className="text-xl font-bold mb-4 text-[#2EB6EE]">{t('technologies.cloudPlatforms')}</h3>
                        ...
                        <motion.div
                            ...
                            className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300"
                        >
                            <h3 className="text-xl font-bold mb-4 text-[#8FBE53]">{t('technologies.operatingSystems')}</h3>
                            <div className="flex flex-wrap gap-3">
                        ...
                        <motion.div
                            ...
                            className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300"
                        >
                            <h3 className="text-xl font-bold mb-4 text-[#FFD700]">{t('technologies.databases')}</h3>
                            <div className="flex flex-wrap gap-3">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-12">
                            {[
                                { title: t('process.steps.0.title'), description: t('process.steps.0.description') },
                                { title: t('process.steps.1.title'), description: t('process.steps.1.description') },
                                { title: t('process.steps.2.title'), description: t('process.steps.2.description') },
                                { title: t('process.steps.3.title'), description: t('process.steps.3.description') },
                                { title: t('process.steps.4.title'), description: t('process.steps.4.description') }
                            ].map((step, index) => (
                                <motion.div
                                    key={index}
                                    initial="hidden"
                                ...
                                >
                                    <div className={`hidden md:flex absolute ${index % 2 === 0 ? 'left-1/2' : 'right-1/2'} -translate-y-12 transform ${index % 2 === 0 ? '-translate-x-8' : 'translate-x-8'} w-16 h-16 rounded-full bg-gradient-to-r from-[#8FBE53] to-[#2EB6EE] text-white items-center justify-center text-xl font-bold z-10 shadow-lg`}>
                                        {index + 1}
                                    </div>

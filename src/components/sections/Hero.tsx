      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center md:block">
          <motion.h1
            ...
            className="text-5xl sm:text-5xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-5xl font-bold leading-tight mb-4 md:mb-6 flex flex-col items-center md:block"
          >
